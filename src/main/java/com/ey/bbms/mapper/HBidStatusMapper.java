...
public class HBidStatusMapper extends BaseMapper implements RowMapper<HBidStatus> {

    @Override
    public HBidStatus mapRow(ResultSet rs, int rowNum) throws SQLException {
	HBidStatus bs = new HBidStatus();
